...
try {
  ...
  New-AzEventHub -ResourceGroupName $resourceGroupName -NamespaceName $eventHubName -Name click-stream-events -PartitionCount 1 -WarningAction Ignore -ErrorAction Stop | Out-Null
  Write-Host -ForegroundColor Green " Done"
