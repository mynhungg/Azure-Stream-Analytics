...
try {
  ...
  New-AzEventHub -ResourceGroupName $resourceGroupName -NamespaceName $eventHubName -Name click-stream-events -PartitionCount 1 -RetentionTimeInHour 168 -CleanupPolicy Delete -WarningAction Ignore -ErrorAction Stop | Out-Null
  Write-Host -ForegroundColor Green " Done"
